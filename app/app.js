...
app.controller('MainController', function ($rootScope, $scope) {
    ...
    $scope.lorem = 'Your Homework Contents are here.';

    // Fake text i used here and there.
    $scope.result = 'Your Result Contents are here.';
    // Fake text i used here and there.
    $scope.engage = 'Your Engage Contents are here.';
    // Fake text i used here and there.
    $scope.events = 'Your Events Contents are here.';
